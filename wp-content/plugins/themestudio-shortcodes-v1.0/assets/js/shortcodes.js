jQuery(document).ready(function($) {
		$(".ts-variable").each(function() {
		    ...
		    var gridContainer = $('#grid-portfolio-ts'),
		        filtersContainer = $('#filters-portfolio-ts'),
		        ...
		        singlePageCallback: function(url, element) {
		            ...
		            $.ajax({
		                ...
		                .done(function(result) {
						    ...
						    // Banner portfolio  
						    $('.ts-single-portfolio .banner-portfolio').each(function(){
						        var bg_src = $(this).attr('data-background');
						        $(this).css({
...
// FEATURE
	...
	$('.bg-feature .img-feature').each(function(){
		var bg_src = $(this).attr('data-background');
		$(this).css({
			'background-image' : 'url("' + bg_src + '")'
		});
...
//Service
	$('.ts-service-img .img-service').each(function(){
		var bg_src = $(this).attr('data-background');
		$(this).css({
			'background-image' : 'url("' + bg_src + '")'
		});
...
//Blog
	$('.list-recent-post .img-blog').each(function(){
		var bg_src = $(this).attr('data-background');
		$(this).css({
			'background-image' : 'url("' + bg_src + '")'
		});
